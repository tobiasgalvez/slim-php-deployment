...
class Pedido
{
    ...
    public function crearPedido()
    {
        try {
            ...
            ("INSERT INTO pedidos (precio_total, id_producto, id_usuario, id_mesa, codigo, estado, horario_llegada, horario_salida) 
            VALUES (:precio_total, :id_producto, :id_usuario, :id_mesa, :codigo, :estado, :horario_llegada, :horario_salida)");
...
{
    $objAccesoDatos = AccesoDatos::obtenerInstancia();
    $consulta = $objAccesoDatos->prepararConsulta("SELECT id, precio_total, id_producto, id_usuario, id_mesa, codigo, estado, horario_llegada, horario_salida 
...
public static function modificarPedido(Pedido $pedidoIngresado)
{
    ...
    if ($pedidoAModificar != null) 
    {
        ...
        $consulta = $objAccesoDato->prepararConsulta("UPDATE pedidos 
            SET precio_total = :precio_total, id_producto = :id_producto, id_usuario = :id_usuario, id_mesa = :id_mesa, codigo = :codigo, estado = :estado, horario_llegada = :horario_llegada, horario_salida = :horario_salida
            WHERE id = :id");
